...
namespace QLKTX
{
    public partial class Form10 : Form
    {
        ...
        private void btntimkiem_Click(object sender, EventArgs e)
        {
            ...
            {
                errorProvider1.SetError(txtTKMP, "Hãy Nhập Mã Sinh Viên");
                errorProvider1.SetError(txtTKtenphong, "Hãy Nhập Tên Sinh Viên");
            }
            else
            {
        ...
        private void btnsua_Click(object sender, EventArgs e)
        {
            ...
            dtbase.DataChange("Update tblPhong  set TenPhong = N'" + txttenphong.Text + "'," +
               ...
               "SoNguoiToiDa='" + txtsonguoitoida.Text + "', SoNguoiDangO='" + txtsonguoio.Text + "', GhiChu='" + txtghichu.Text +
               "' Where MaPhong = '" + txtMP.Text + "' ");
            Loaddata();
