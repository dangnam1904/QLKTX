        ...
        private void btnluu_Click(object sender, EventArgs e)
        {
            ...
            {  //Kiểm  tra  xem  ô  nhập  MaSV  có  bị  trống  không 
                ...
                if (rdonu.Checked == true)
                    GioiTinh = "Nữ";
                //Insert vao CSDL
                sql = "INSERT INTO tblSinhVien(MaSinhVien, TenSinhVien, NgaySinh, GioiTinh, MaQue, MaKhoa, MaLop) VALUES(";
                sql += "N'" + txtMSV.Text + "',N'" + txtHoten.Text + "','" + dtpngaysinh.Value.ToString("MM/dd/yyyy") + "'" +
                    ",N'" + GioiTinh + "',N'" + cbxmaque.SelectedValue.ToString() + "',N'" + cbxmakhoa.SelectedValue.ToString() + "',N'" + cbxmalop.SelectedValue.ToString() + "')";
            }
            ...
            { 
                sql = "Update tblSinhVien SET TenSinhVien =N'" + txtHoten.Text + "',NgaySinh='" + dtpngaysinh.Value.ToString("MM/dd/yyyy") + "'" +
                     ",GioiTinh=N'" + Gioitinh + "',MaQue=N'" + cbxmaque.SelectedValue.ToString() + "'," +
                     "MaKhoa=N'" + cbxmakhoa.SelectedValue.ToString() + "',MaLop=N'" + cbxmalop.SelectedValue.ToString() +
                     "' Where MaSinhVien=N'" + txtMSV.Text + "'";
                dgvsinhvien.DataSource= database.DataReader(sql);
                LoadData();
            }
            ...
            {
                sql = "Delete From tblSinhVien Where MaSinhVien =N'" + txtMSV.Text + "'";
            }
