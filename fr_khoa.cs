...
namespace QLKTX
{
    public partial class fr_khoa : Form
    {
        ...
        private void btnThem_Click_1(object sender, EventArgs e)
        {
            ...
            //Tạo câu lệnh sql
            string sqlInsertKhoa = "insert into tblKhoa values('" + txtmakhoa.Text + "',N'" + txttenkhoa.Text + "')";
        ...
        private void btnsua_Click_1(object sender, EventArgs e)
        {
            ...
            dtbase.DataChange("Update tblKhoa set MaKhoa = '" + txtmakhoa.Text + "',TenKhoa = N'" + txttenkhoa.Text + "'Where MaKhoa='" + txtmakhoa.Text + "' ");
            LoadData();
            btnsua.Enabled = false;
            btnxoa.Enabled = false;
